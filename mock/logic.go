...
func (r *UserLogic) GetByUsername(ctx context.Context, username string) (model.User, error) {
...
func (r *UserLogic) Create(ctx context.Context, u model.User) (int64, error) {
	args := r.Called(ctx, u)
